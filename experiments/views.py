...
def check_participant(request):
    ...
    if 'participant_uuid' in request.session:
        ...
        if 'participant_uuid' not in request.POST:
            ...
            return render(request, 'experiments/error.html', context)
...
def load_documentation(request):
    return render(request, 'experiments/documentation.html')

def load_about(request):
    return render(request, 'experiments/about.html')

def load_charts(request):
    return render(request, 'experiments/charts.html')

def load_history(request):
    return render(request, 'experiments/history.html')