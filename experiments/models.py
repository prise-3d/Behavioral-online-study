...
class SessionProgress(PolymorphicModel):
    ...
    id = models.AutoField(primary_key=True, editable=False, unique=True)
    session = models.ForeignKey(Session, null=True, related_name='progresses', on_delete=models.CASCADE)
...
class SessionStep(models.Model):
    ...
    progress_type = models.ForeignKey(ContentType, related_name='steps', on_delete=models.CASCADE)
